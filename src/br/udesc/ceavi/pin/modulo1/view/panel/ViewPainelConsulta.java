...
//                        ViewFrameDadosEdge view = new ViewFrameDadosEdge();
//
//                        if(d.getJanela(view.getNome()) != null) {
//                            view = (ViewFrameDadosEdge)d.getJanela(view.getNome());
//                        } else {
//                            d.adicionaJanela(view);
//                        }
//
//                        view.abreJanela();
//                        String[][] id = getValoresSelecao();
//                        new ViewListenersDadosEdge(view, getEdge(id[0][1]));
//                    }
//
//              }); 
	 ...
	 * @param chave - se o campo é chave.
	 */
